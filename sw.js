const CACHE='genius-academy-v6';
const CORE=['/','/academy.css','/academy.js','/question-safety.js','/mission-quality.js','/chores.js','/game-world.css','/game-world.js','/world.css','/world3d.js','/world-nav.js','/parent-settings.js','/manifest.webmanifest'];
