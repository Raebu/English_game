const CACHE='genius-academy-v3';
const CORE=['/','/academy.css','/academy.js','/question-safety.js','/game-world.css','/game-world.js','/world.css','/world.js','/parent-settings.js','/manifest.webmanifest'];
