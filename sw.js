const CACHE='genius-academy-v4';
const CORE=['/','/academy.css','/academy.js','/question-safety.js','/mission-quality.js','/chores.js','/game-world.css','/game-world.js','/world.css','/world.js','/parent-settings.js','/manifest.webmanifest'];
