const CACHE='genius-academy-v2';
const CORE=['/','/academy.css','/academy.js','/game-world.css','/game-world.js','/world.css','/world.js','/parent-settings.js','/manifest.webmanifest'];
