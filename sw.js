const CACHE='genius-academy-v5';
const CORE=['/','/academy.css','/academy.js','/question-safety.js','/no-repeat.js','/chores.js','/game-world.css','/game-world.js','/world.css','/world3d.js','/world-nav.js','/parent-settings.js','/manifest.webmanifest'];
